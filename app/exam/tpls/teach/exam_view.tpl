			...
			<div class="col-xs-9 split pull-right" style="padding:0px;position:relative;">
				...
				<div class="box itembox paperexamcontent">
					...
					<div class="decidediv" style="border-left:10px solid #CCCCCC;position:relative;">
						...
						<div class="right"></div>
						{x2;elseif:$sessionvars['examsessionscorelist'][v:question['questionid']] && $sessionvars['examsessionscorelist'][v:question['questionid']] == $sessionvars['examsessionsetting']['examsetting']['scores'][v:question['questionid']]}
						<div class="right"></div>
						{x2;else}
						<div class="wrong"></div>
						{x2;endif}
	                	<table class="table table-hover table-bordered">
	                    	...
	                    	<tr>
	                    		<td>考生答案：</td>
	                        	<td>
									{x2;if:$questype[v:quest]['questchoice'] == 102 && $sessionvars['examsessionuseranswer'][v:question['questionid']]}
									<a class="btn btn-primary" href="{x2;realhtml:$sessionvars['examsessionuseranswer'][v:question['questionid']]}">下载文件</a>
									{x2;else}
				...
				<div class="box itembox paperexamcontent">
					...
					<div class="decidediv" style="border-left:10px solid #EDEDED;position:relative;">
	                	{x2;if:$sessionvars['examsessionscorelist'][v:data['questionid']] && $sessionvars['examsessionscorelist'][v:data['questionid']] == $sessionvars['examsessionsetting']['examsetting']['questype'][v:quest]['score']}
						<div class="right"></div>
						{x2;elseif:$sessionvars['examsessionscorelist'][v:data['questionid']] && $sessionvars['examsessionscorelist'][v:data['questionid']] == $sessionvars['examsessionsetting']['examsetting']['scores'][v:data['questionid']]}
						<div class="right"></div>
						{x2;else}
						<div class="wrong"></div>
						{x2;endif}
