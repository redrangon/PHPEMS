							...
							<li class="border morepadding rightanswer">
								<div class="intro">
									<div class="desc">
										...
										<div class="col-xs-11">
											{x2;if:$questype[v:quest]['questchoice'] == 102 && $eh['ehuseranswer'][v:question['questionid']]}
                                            <a class="btn btn-primary" href="{x2;realhtml:$eh['ehuseranswer'][v:question['questionid']]}">下载文件</a>
											{x2;else}
