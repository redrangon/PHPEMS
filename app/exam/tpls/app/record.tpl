				...
				<div class="col-xs-9 nopadding">
					<div class="content-box padding">
						<ul class="nav nav-tabs">
							<li class="active"><a href="index.php?exam-app-record">试题列表</a></li>
							<li><a href="index.php?exam-app-record-papers">组卷练习</a></li>
						</ul>
					</div>
					...
					<div class="content-box padding">
						<h2 class="title">
							...
							<a class="badge pull-right ajax" href="index.php?exam-app-record-ajax-delrecord&recordid={x2;v:question['recordid']}">移除</a>
					...
					<div class="content-box noground padding">
						...
						<ul class="pagination pull-right">{x2;$questions['pages']}</ul>
						{x2;endif}
					</div>
				</div>
			</div>
