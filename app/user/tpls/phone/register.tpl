...
<div class="pages">
		...
		<div class="page-content header">
			...
			<form class="top" action="index.php?user-phone-register" method="post">
				<div class="form-group underline">
					...
					<div class="col-7">
						<input type="text" datatype="userName" needle="needle" msg="请输入用户名" class="noborder" name="args[username]" placeholder="请输入用户名">
					</div>
				</div>
				<div class="form-group underline">
					<div class="col-3 tip">
					...
					<div class="col-7">
						<input type="text" datatype="email" needle="needle" id="email" msg="请输入邮箱" class="noborder" name="args[useremail]" placeholder="请输入邮箱">
					</div>
				</div>
				...
				<div class="form-group underline">
					...
					<div class="col-7">
						<input type="password" datatype="password" needle="needle" msg="请输入密码" class="noborder" name="args[userpassword]" placeholder="请输入密码">
					</div>
				</div>
				<div class="form-group underline">
					<div class="col-3 tip">
					...
					<div class="col-7">
						<input type="password" datatype="password" needle="needle" msg="请输入密码" class="noborder" placeholder="请输入密码">
					</div>
				</div>
				...
				<div class="form-group text-center">
					<label class="inline"><input type="radio" name="agreement" checked><span class="selector">同意《注册协议》</span></label>
				</div>
				...
				<div class="form-group text-center">
					...
					<div class="hide" id="agreementtxt">{x2;block:1}</div>
				</div>
			</form>
		</div>
	</div>
	<script>
		$(function(){
			pep.mask.show('rtf',{message:$('#agreementtxt').html(),btntxt:'同意并继续'});
		});
	</script>
    {x2;if:$app['appsetting']['emailverify']}
	<script>
