...
class WxPayConfig extends WxPayConfigInterface
{
	...
	public function __construct($agent = 'wxapp')
	{
		$this->agent = $agent;
	}
	...
	{
		if($this->agent == 'mpapp')return MPAPPID;
        if($this->agent == 'openapp')return OPENAPPID;
		return WXAPPID;
	}
	...
	**/
	...
	{
		if($this->agent == 'mpapp')return MPAPPSECRET;
        if($this->agent == 'openapp')return OPENAPPSECRET;
		return WXAPPSECRET;
	}
